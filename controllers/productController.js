...
const addProduct = async (req, res) => {
  try {
    upload(req, res, async function (err) {
      ...
      const categoryDiscount = categoryDetails.discount;
      const categoryDiscountPrice = price - (price * categoryDiscount / 100);
...
const updateProduct = async (req, res) => {
  try {
    newupload(req, res, async function (err) {
      ...
      const productId = req.params.id;
      const { name, description, price, category, stock, discountPrice, categoryDiscountPrice } = req.body;
      ...
      product.categoryDiscountPrice = categoryDiscountPrice;
